...
public partial class TdcTchEstadoPedido
{
    ...
    /// <summary>
    /// Código que identifica de forma unívoca un pedido. Se construye con:
    /// provincia-codfarmacia-id
    /// </summary>
    public string CodPedido { get; set; } = null!;

    /// <summary>
    /// Código que identifica de forma unívoca la línea de distribución por carretera que sigue el envío:
